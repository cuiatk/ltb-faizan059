...
public class Customer {
		 ...
		 */
		/**
		  * This method constructing a statement which has name of person.movies being rented, rental of that person.
		 * 
		 * @return a statement which contain the name of person who is renting movies 
		 * and name of all movies which are being rented by that specific with their 
